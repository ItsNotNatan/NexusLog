...
// --- ENVIO PARA O BACKEND (NODE.JS) ---
  const handleEnviar = async () => {
    ...
    // AVISO VISUAL DE QUE ESTÁ A PROCESSAR
    // (Podes criar um estado setCarregando(true) aqui se quiseres bloquear o botão)
    ...
    if (anexos.length > 0) {
      for (const arquivo of anexos) {
        ...
        const caminhoNoStorage = `uploads/${nomeUnico}`; // Vai guardar dentro duma pasta "uploads"
